...
从 demo 式 RAG 升级到模块化原型
引入 parser / router / chunking / vector_store / pipeline 分层
支持文档重建索引
支持检索调试和召回可视化
发现并验证了“不同文档结构需要不同 chunk 策略”的工程问题
初步具备工程化 RAG 的基本思路
...
这是一个面向文档问答场景的工程化 RAG 原型，重点不在于“堆框架”，而在于：
...
这个项目展示的并不只是“调用了大模型”，而是一个更真实的 RAG 迭代过程：
...
它更接近一个可以继续扩展的 RAG 工程原型，而不是单次脚本演示。

![上传界面](assets/1.png width="600")
![上传界面](assets/2.png width="600")
![上传界面](assets/3.png width="600")